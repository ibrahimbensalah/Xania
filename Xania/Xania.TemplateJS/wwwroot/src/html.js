...
var Select = (function () {
    ...
    Select.prototype.view = function () {
        ...
        return (xania_1.Xania.tag("div", { className: "form-group" },
            xania_1.Xania.tag("label", { htmlFor: id }, this.attrs.display),
            xania_1.Xania.tag("select", { className: "form-control", id: id, onChange: onChange },
